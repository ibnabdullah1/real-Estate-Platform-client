const Footer = () => {
  return (
    <footer>
      <div className="bg-[#1c4456] 154245 py-4 text-gray-300">
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-[#417086]">
                  Company
                </h2>
              </div>
              <ul className="leading-8">
                <li>
                  <a href="#" className="hover:text-[#417086]">
                    About Us
                  </a>
                </li>
                <li>
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-[#417086] hover:border-[#417086]"
              >
                <svg
              ...
              <a
                href="#"
                className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-[#417086] hover:border-[#417086]"
              >
                <svg
                  className="w-4 h-4 fill-current"
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-[#417086] py-4 text-gray-100">
