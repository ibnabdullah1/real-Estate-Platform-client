...
import property2 from "../../assets/images/property (15).jpg";
import property1 from "../../assets/images/property (17).jpg";
import property3 from "../../assets/images/property (18).jpg";
const ServiceDescription = () => {
  return (
    <div>
      <img src={property1} alt="" className="w-full h-[300px] object-cover" />
      <p className="mt-2">
      ...
      <div className="flex-col gap-3 mt-3 flex-align-center sm:flex-row">
        <img src={property2} alt="" className="w-full h-[250px] object-cover" />
        <img src={property3} alt="" className="w-full h-[250px] object-cover" />
      </div>
      <p className="mt-3">
